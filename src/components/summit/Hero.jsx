    ...
    <section className="relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-28 pb-20">
        ...
        <motion.div
          ...
          <span className="text-[#171c26cc] text-sm flex items-center gap-2 sm:text-base">Thursday, May 28, 2026


          </span>
          <span className="hidden sm:inline text-[#714DFF]/30">|</span>
          <span className="text-[#171c26cc] text-sm flex items-center gap-2 sm:text-base">Midtown Manhattan


          </span>
          <span className="hidden sm:inline text-[#714DFF]/30">|</span>
          <span className="text-[#171c26cc] text-sm flex items-center gap-2 sm:text-base">200+ Curated Leaders
